...
fetch(apiURL)
    ...
    .then((jsObject) => {
        ...
        document.getElementById('windchill').textContent = Math.round(0.0817 * (3.71*(Math.pow(jsObject.list[0].wind.speed, 0.5))+ 5.81 - 0.25 * jsObject.list[0].wind.speed)*(((jsObject.list[0].main.temp_max)*(9/5) - 459.67)-95.4)+ 83.4);  
    })
//WindChill//
